...
class SecurityEnhancer:
    ...
    def detect_suspicious_activity(self, request: Request) -> bool:
        ...
        if any(admin_path in path for admin_path in admin_paths) and not self._is_admin_ip(client_ip):
    ...
    def hash_sensitive_data(self, data: str, salt: str | None = None) -> dict[str, str]:
    ...
    def validate_url(self, url: str, allowed_domains: list[str] | None = None) -> bool:
