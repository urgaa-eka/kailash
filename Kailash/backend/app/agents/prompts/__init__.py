...
from .arjun_prompts import ARJUN_PROMPTS, get_all_arjun_prompts, get_arjun_prompt
from .ganesha_prompt import (
    AGENT_ROUTING_CONFIG,
    GANESHA_SYSTEM_PROMPT,
    get_ganesha_prompt,
    get_routing_config,
)
from .gstsaas_prompts import GSTSAAS_PROMPTS, get_all_gstsaas_prompts, get_gstsaas_prompt
from .ignition_prompts import IGNITION_PROMPTS, get_all_ignition_prompts, get_ignition_prompt
from .urgaa_prompts import URGAA_PROMPTS, get_all_urgaa_prompts, get_urgaa_prompt
...
def route_to_agent(query: str, product_context: str = None) -> str:
    ...
    for _product, config in routing_config.items():
...
__all__ = [
    ...
    # Bulk getters (re-exported alongside their single-prompt counterparts)
    "get_all_urgaa_prompts",
    "get_all_gstsaas_prompts",
    "get_all_ignition_prompts",
    "get_all_arjun_prompts",

    # Routing config accessor
    "get_routing_config",
]
