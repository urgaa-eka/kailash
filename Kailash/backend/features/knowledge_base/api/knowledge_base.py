...
from backend.features.eka_brain.services.rag_knowledge_base import get_rag_knowledge_base
from backend.platform.core.mongodb import MongoD
from backend.platform.deps import get_current_user
...
class QueryRequest(BaseModel):
    ...
    filter_by_product: str | None = Field(default=None, pattern="^(all|urgaa|gstsaas|ignition|arjun)$")
    filter_by_type: str | None = Field(default=None, pattern="^(foundation|product|operations|technical|training)$")
