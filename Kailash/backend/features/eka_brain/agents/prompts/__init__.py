...
from backend.features.eka_brain.agents.prompts.arjun_prompts import (
    ARJUN_PROMPTS,
    get_all_arjun_prompts,
    get_arjun_prompt,
)
from backend.features.eka_brain.agents.prompts.ganesha_prompt import (
    AGENT_ROUTING_CONFIG,
    GANESHA_SYSTEM_PROMPT,
    get_ganesha_prompt,
    get_routing_config,
)
from backend.features.eka_brain.agents.prompts.gstsaas_prompts import (
    GSTSAAS_PROMPTS,
    get_all_gstsaas_prompts,
    get_gstsaas_prompt,
)
from backend.features.eka_brain.agents.prompts.ignition_prompts import (
    IGNITION_PROMPTS,
    get_all_ignition_prompts,
    get_ignition_prompt,
)
from backend.features.eka_brain.agents.prompts.urgaa_prompts import (
    URGAA_PROMPTS,
