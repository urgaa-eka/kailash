...
from backend.platform.core.performance import monitor_performance, perf_monitor
from backend.platform.core.security_enhancements import security_enhancer
