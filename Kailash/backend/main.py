...
from backend.features.analytics.api import analytics
from backend.features.auth.api import auth, rbac
from backend.features.automobile_pricing.engine import router as automobile_router
from backend.features.departments.api import departments
from backend.features.eka_brain.api import (
    conversations,
    ganesha,
    ganesha_multimodel,
...
from backend.features.executive_dashboard.api import dashboard
from backend.features.guardians.api import guardians, shiv_auto_rectify
from backend.features.tasks.api import tasks
from backend.features.users.api import users
from backend.platform.core.config import settings
from backend.platform.core.database import db_manager
from backend.platform.core.db_indexes import create_indexes
from backend.platform.core.firebase import init_firebase
from backend.platform.core.mongodb import MongoD
from backend.platform.core.performance import performance_monitoring_task
from backend.platform.core.seeder import seed_database
from backend.platform.health import simple_health, system_health
from backend.platform.middleware.error_handler import error_handler
from backend.platform.middleware.security import security_middleware
...
try:
    from backend.features.eka_brain.api_v2 import ganesha_router as ganesha_v2_router
except ImportError:
    try:
        from backend.features.eka_brain.api_v2 import ganesha_router as ganesha_v2_router
    except ImportError:
