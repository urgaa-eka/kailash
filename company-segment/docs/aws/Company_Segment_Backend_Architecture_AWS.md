...
*(Rendered copies of this and the data-flow diagram live in this folder: `architecture.png/.svg`, `dataflow.png/.svg`, Mermaid sources `.mmd`.)*

![Company segment AWS architecture](./architecture.png)
